                                ...
                                >
                                    <SwiperSlide>
                                        <div className="gallary-item">
                                            <img src={`http://backend.pevite.com.ve/${producto.imagenes.medium[0]}`} alt="shop"/>
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <div className="gallary-item">
                                            <img src={`http://backend.pevite.com.ve/${producto.imagenes.medium[1]}`} alt="shop"/>
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <div className="gallary-item">
                                            <img src={`http://backend.pevite.com.ve/${producto.imagenes.medium[2]}`} alt="shop"/>
                                        </div>
                                    </SwiperSlide>
                                </Swiper>
                                ...
                                >
                                    <SwiperSlide>
                                        <div className="thumb-item">
                                            <img src={`http://backend.pevite.com.ve/${producto.imagenes.small[0]}`} alt="shop"/>
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <div className="thumb-item">
                                            <img src={`http://backend.pevite.com.ve/${producto.imagenes.small[1]}`} alt="shop"/>
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <div className="thumb-item">
                                            <img src={`http://backend.pevite.com.ve/${producto.imagenes.small[2]}`} alt="shop"/>
                                        </div>
                                    </SwiperSlide>
                                </Swiper>
                            </div>
